...
<div class="single-hotel-wrapper">
  <div class="col-md-12 no-padding hotel-name">
      <h3><a href="<?php echo $list['hotel_url'].'?aid=304142'; ?>" class="" target="_blank"><?php echo $list['hotel_name']; ?></a></h3>
    </div>
    <div class="col-md-3 padding-left-0">
     <a href="<?php echo $list['hotel_url'].'?aid=304142'; ?>" class="" target="_blank"><img src="<?php echo $list['photo_url']; ?>" width="100%" alt="" class="img-responsive hotel-img"/></a>
...
<div class="col-md-3 text-center reviews">
      ...
      <?php } ?>
        <a href="<?php echo $list['hotel_url'].'?aid=304142'; ?>" class="link-button-small" target="_blank">Book Hotel<i class="fa fa-map-marker" aria-hidden="true"></i></a>
        <?php /* ?> 

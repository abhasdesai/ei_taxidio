<div class="container">
  <div class="navbar-header">
    ...
    <a class="navbar-brand dashboard-logo" href="<?php echo site_url(); ?>"><img src="<?php echo site_url('assets/images/logo.png') ?>" alt="Taxidio - The Where, Why & How Traveler"/></a> </div>
  ...
  <div id="navbar" class="navbar-collapse collapse">
    ...
    <ul class="nav navbar-nav navbar-right" itemscope itemtype="http://www.schema.org/SiteNavigationElement">
      ...
      <li class="" itemprop="name"><a href="<?php echo site_url('hotels') ?>" itemprop="url" class="hvr-shutter-in-horizontal <?php if(isset($webpage) && $webpage=='hotels'){ echo 'active'; } ?>">Hotels</a></li>

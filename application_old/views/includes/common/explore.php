...
<div class="container-fluid">
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center explorecountry">
                <h2>Destinations</h2>
                <p>Spreading our wings across every continent, we encompass over 110 countries and 500 cities. From sky-spearing mountains to glistening coastlines, heritage edifices to contemporary structures, our multiple-destination trip planner befits every style of travel. </p>
            </div>
        </div>
    </div>
    </div>

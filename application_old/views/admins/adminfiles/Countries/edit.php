				 ...
				 <div class="row">
			 		 ...
			 		 <div class="col-md-12">
						  <div class="form-group">
							...
							<input type="text" id="country_neighbours" name="country_neighbours" class="form-control required singleFieldTags2" maxlength="500" value="<?php echo $country['country_neighbours']; ?>" autocomplete="off"/>

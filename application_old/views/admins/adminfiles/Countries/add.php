            ...
            <div class="box-body">
			  ...
			  <div class="row">
			   ...
			   <div class="row">
					 <div class="col-md-12">
						  <div class="form-group">
							<label>Country Conclusion</label>
			   ...
			   <div class="row">
					 <div class="col-md-12">
						  <div class="form-group">
							<label>Country Neighbour</label>
							<input type="text" id="country_neighbours" name="country_neighbours" class="form-control required singleFieldTags2" maxlength="500" value="<?php echo set_value('country_neighbours') ?>" autocomplete="off"/>
			   ...
			   <div class="row">
					 <div class="col-md-6">
						  <div class="form-group">
							<label>Country Tourist Rating</label>
				 ...
				 <div class="col-md-6">
						  <div class="form-group">
							<label>Country No Of Annual Tourists</label>

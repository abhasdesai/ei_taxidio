...
class Forum_wm extends CI_Model 
{
    ...
    {
        $this->db->select('tbl_itinerary_questions.id,question,tbl_itinerary_questions.created,userimage,socialimage,name,(select count(id) from tbl_itinerary_answers where tbl_itinerary_answers.question_id=tbl_itinerary_questions.id) as totalcomments,user_id as owner_id,posted_by');

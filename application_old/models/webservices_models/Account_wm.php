...
class Account_wm extends CI_Model
{
	...
	{
		$Q=$this->db->query('select id from tbl_itineraries where country_id="'.$country_id.'" and user_id="'.$_POST['userid'].'" and trip_type=1 and uniqueid="'.$uniqueid.'" limit 1');
		$data=$Q->row_array();
		return $data;
	}
	...
	{
		$Q=$this->db->query('select id from tbl_itineraries where country_id="'.$country_id.'" and user_id="'.$_POST['userid'].'" and trip_type=3 and uniqueid="'.$uniqueid.'" limit 1');
		$data=$Q->row_array();
		return $data;
	}
...
function getoldSearchedCitiesOfCountryIti($country_id,$cities,$iti)
	...
	function update_single_itinerary($country_id)
	{
			...
			$itineraryid=getrowbycondition('id','tbl_itineraries',"id='".$_POST['itineraryid']."' and user_id=$userid and country_id=$country_id and uniqueid='".$_POST['uniqueid']."' and trip_type=1");
			$tripname='';
			$citiorcountries ='';
	...
	function update_searched_itinerary($country_id)
	{
		...
		$cities=json_decode($cities_encode,TRUE);
		$maincity=$_POST['main_cityid'];
		$itineraryid=getrowbycondition('id','tbl_itineraries',"id='".$_POST['itineraryid']."' and user_id=$userid and country_id=$country_id and uniqueid='".$_POST['uniqueid']."' and trip_type=3");
		$tripname='';
	...
	{
		$itineraryid=getrowbycondition('id','tbl_itineraries',"id='".$_POST['itineraryid']."' and user_id='".$_POST['userid']."' and uniqueid='".$_POST['uniqueid']."' and trip_type=2");

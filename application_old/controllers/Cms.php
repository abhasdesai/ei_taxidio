...
class Cms extends Front_Controller {
	...
	function discover_taxidio()
	{
		...
		$data['meta_title']='The Vacation Trip Planner :: Travel Search Engine';
		...
		$data['meta_description']='Taxidio, a leading travel search engine, is a free online holiday trip planner that bridges the gap between planning & execution. Explore our vacation trip planner today!';
		$this->load->vars($data);
		$this->load->view('templates/innermaster');
	}

...
class Planneditineraries extends Admin_Controller {
	...
	{
		$aColumns = array('id','slug','user_trip_name','name','trip_type','trip_mode','created');
		...
		*/
		...
		// Select Data
		$this->db->select("SQL_CALC_FOUND_ROWS tbl_itineraries.id,user_trip_name,name,trip_mode,isblock,slug,trip_type,tbl_itineraries.created", FALSE);

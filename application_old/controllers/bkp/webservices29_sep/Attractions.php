	...
	function tripTodestination_post()
	{
		...
		$other=1;
			...
			$data['message']=array();
				...
				// 	if($inputs['sdays']<$ttldays)
				// 	{
				// 		$data[0]['message']='Your preferred number of days is less than the time suggested to tour the chosen destination(s). Would you like to extend your stay?';
				// 		$data[0]['msg']="Based on the parameters selected, we think ". $inputs['sdestination'] ." can be explored well in ".$ttldays." days.";
				// 		$data[0]['needed_more_days']=$ttldays;
				// 		$other=0;
				// 	}
				// 	else {
				// 		$data[0]['message']='Your preferred number of travel days exceed the recommended time required to tour the chosen destination(s). Would you like to explore an additional city?';
				// 		$data[0]['msg']="";
				// 		$data[0]['needed_more_days']="";
				// 		$other=1;
				// 	}
				// }

...
class Home extends Front_Controller {
	...
	function index()
	{
		...
		$this->session->unset_userdata('storage');
		$data['meta_title']='Travel Itinerary Maker | Holiday & Vacation Trip Planner | Taxidio';
		...
		$data['meta_description']='Plan a trip with trip Itinerary builder. Create itinerary online with our itinerary planner. Taxidio is your best vacation trip planner this holiday season.';
		...
		if($this->config->item('base_url')=='http://192.168.0.148/taxidio/')
		{
			$data['blogs'] = array();
		}
		else
